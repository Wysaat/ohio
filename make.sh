...
cc -nostdlib -nostdinc -fno-builtin -fno-stack-protector kernel.c io.c idt.c isr.c pic.c pit.c -c -m32
# CAUTION: don't forget to add *.o to ld after adding a *.c!
ld -T link.ld kernel.o io.o idt.o isr.o isr.s.o pic.o pit.o -m elf_i386 -o kernel
